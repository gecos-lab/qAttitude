...
To install, just download [qattitude.zip](https://github.com/gecos-lab/qAttitude/releases/download/v0.1/qattitude.zip), then in QGis > Plugins > Manage and Install Plugins > Install from ZIP > select qattitude.zip > Install Plugin > Yes > Close, and you will find qAttitude in the Plugins menu and toolbar.
