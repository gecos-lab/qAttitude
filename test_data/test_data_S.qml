...
<qgis hasScaleBasedVisibilityFlag="0" minScale="100000000" autoRefreshMode="Disabled" simplifyLocal="1" readOnly="0" version="3.44.8-Solothurn" styleCategories="LayerConfiguration|Symbology|MapTips|AttributeTable|Rendering|CustomProperties|Temporal|Elevation|Notes" maxScale="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyDrawingTol="1" autoRefreshTime="0" symbologyReferenceScale="-1" simplifyAlgorithm="0">
  <flags>
  ...
  <temporal endField="" accumulate="0" mode="0" startExpression="" enabled="0" durationUnit="min" endExpression="" durationField="DIPDIR" fixedDuration="0" startField="" limitMode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation symbology="Line" customToleranceEnabled="0" type="IndividualFeatures" zscale="1" showMarkerSymbolInSurfacePlots="0" clamping="Absolute" respectLayerSymbol="1" extrusion="0" extrusionEnabled="0" zoffset="0" binding="Centroid">
    ...
    <profileLineSymbol>
      <symbol type="line" alpha="1" force_rhr="0" is_animated="0" name="" frame_rate="10" clip_to_extent="1">
        ...
        <layer id="{e521c0cb-37dd-44c8-abb8-ac1a9491b886}" enabled="1" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" alpha="1" force_rhr="0" is_animated="0" name="" frame_rate="10" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{70ae0ab6-0172-425f-820a-dca61b2eef8b}" enabled="1" class="SimpleFill" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol type="marker" alpha="1" force_rhr="0" is_animated="0" name="" frame_rate="10" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{453f7313-51ea-4edf-adda-ec79f16cdb42}" enabled="1" class="SimpleMarker" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 type="singleSymbol" referencescale="-1" enableorderby="0" symbollevels="0" forceraster="0">
    <symbols>
      <symbol type="marker" alpha="1" force_rhr="0" is_animated="0" name="0" frame_rate="10" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{3a8c2fdd-e969-46d6-825f-209886c5984d}" enabled="1" class="FontMarker" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="o" name="chr"/>
            <Option type="QString" value="192,94,225,255,hsv:0.79166666666666663,0.58431372549019611,0.88235294117647056,1" name="color"/>
            <Option type="QString" value="ESRI Geology" name="font"/>
            <Option type="QString" value="Regular" name="font_style"/>
            <Option type="QString" value="1" name="horizontal_anchor_point"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,-10.33333333333333748" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="Point" name="offset_unit"/>
            <Option type="QString" value="0,204,69,255,rgb:0,0.8,0.2705882,1" name="outline_color"/>
          ...
          <effect type="effectStack" enabled="1">
            ...
            <effect type="outerGlow">
              <Option type="Map">
                <Option type="QString" value="19" name="blend_mode"/>
                <Option type="QString" value="2" name="blur_level"/>
                <Option type="QString" value="Point" name="blur_unit"/>
                <Option type="QString" value="3x:0,0,0,0,0,0" name="blur_unit_scale"/>
                <Option type="QString" value="69,116,40,255,rgb:0.2705882,0.454902,0.1568627,1" name="color1"/>
                <Option type="QString" value="188,220,60,255,rgb:0.7372549,0.8627451,0.2352941,1" name="color2"/>
                ...
                <Option type="QString" value="Point" name="spread_unit"/>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="angle">
                  ...
                  <Option type="QString" value="DIPDIR" name="field"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="marker" alpha="1" force_rhr="0" is_animated="0" name="" frame_rate="10" clip_to_extent="1">
        ...
        <layer id="{d5831dbc-64e1-47c0-8c3d-2bbb9361f2f0}" enabled="1" class="SimpleMarker" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="square" name="cap_style"/>
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="List" name="dualview/previewExpressions">
        <Option type="QString" value="COALESCE( &quot;STOP&quot;, '&lt;NULL>' )"/>
      </Option>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;SUBAREA&quot;" sortOrder="1">
    <columns>
      <column type="field" width="-1" name="DIPDIR" hidden="0"/>
      <column type="field" width="-1" name="DIP" hidden="0"/>
      <column type="field" width="-1" name="SUBAREA" hidden="0"/>
  ...
  <storedexpressions/>
  <previewExpression>COALESCE( "STOP", '&lt;NULL>' )</previewExpression>
