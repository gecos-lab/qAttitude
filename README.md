...
To install, just download [qattitude.zip](https://github.com/gecos-lab/qAttitude/releases/latest/download/qattitude.zip) from the [latest release](https://github.com/gecos-lab/qAttitude/releases/latest/), then in QGis > Plugins > Manage and Install Plugins > Install from ZIP > select qattitude.zip > Install Plugin > Yes > Close, and you will find qAttitude in the Plugins menu and toolbar.
...
[![DOI](https://zenodo.org/badge/1060627551.svg)](https://doi.org/10.5281/zenodo.20745470)
